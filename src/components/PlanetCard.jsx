...
export const PlanetCard = ({ planet }) => {
    ...
    return (
        <div className="container">
            <div className="my-card h-100 rounded">
                <img src={`https://raw.githubusercontent.com/breatheco-de/swapi-images/refs/heads/master/public/images/planets/${planet.url.split("/")[5]}.jpg`} className="rounded-top card-img-top" alt="starwars img" />
                ...
                <div className="m-3 mb-0 d-flex justify-content-between align-baseline">
