...
export const PeopleCard = ({ character }) => {
    ...
    return (
        <div className="my-card mb-4 me-3 rounded">
            <img src={`https://raw.githubusercontent.com/breatheco-de/swapi-images/refs/heads/master/public/images/people/${character.url.split("/")[5]}.jpg`} className="rounded-top card-img-top" alt="starwars img" />
